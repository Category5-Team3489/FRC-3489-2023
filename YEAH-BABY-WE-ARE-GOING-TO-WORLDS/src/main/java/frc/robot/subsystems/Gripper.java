...
public class Gripper extends Cat5Subsystem {
    ...
    public final CommandBase lowOuttakeConeCommand = getNamePercentSecondsCommand("Low Outtake Cone", 0.7, 1.0); // 0.2, 1.0
    ...
    public final CommandBase lowOuttakeCubeCommand = getNamePercentSecondsCommand("Low Outtake Cube", 0.7, 0.5); // 0.5, 0.5
    public final CommandBase midOuttakeCubeCommand = getNamePercentSecondsCommand("Mid Outtake Cube", 0.75, 0.5); // 0.3, 0.5
