...
public final class Constants {
    ...
    * Should be measured from center to center.
    */
    public static final double DRIVETRAIN_WHEELBASE_METERS = 0.54; // FIXME Measure and set wheelbase
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(301.46484375 - 360 - 17.5621); // -54 FIXME Measure and set front left steer offset  //-Math.toRadians(301.46484375 - 360);
    //360 - 305.244140625
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(180); // -4.7 FIXME Measure and set front right steer offset
    ...
    public static final int BACK_LEFT_MODULE_STEER_ENCODER = 18; // FIXME Set back left steer encoder ID
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(65.21484375 + 18.0861); // -130.3 FIXME Measure and set back left steer offset
